<template>
  <div class="sidebar" :class="{ open: isOpen }">
    ...
    <div class="player">
      ...
      <div class="song-info">
        <span id="songTitle" :class="{ 'fade-in': isMusicListOpen }">{{ currentSong.title }}</span>
...
#musicList {
  ...
  max-height: 0; /* 初始高度为0 */
  opacity: 0; /* 初始透明度为0 */
  transform: translateY(-10px); /* 初始位移 */
  transition: opacity,mix-height 0.3s ease, transform 0.3s ease; /* 添加过渡效果 */
