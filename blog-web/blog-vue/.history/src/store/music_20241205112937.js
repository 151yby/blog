...
export const useMusicStore = defineStore('music', {
  state: () => ({
    ...
    currentTime: '0:00',
    playlist: [
      { src: require('../assets/music/1n - デート2(1nCover).mp3'), title: '1n - デート2', cover: require('../assets/album-img/1n - デート2.jpg') },"../assets/music/1n - デート2(1nCover).mp3", title: '1n - デート2', cover: '../assets/album-img/1n - デート2.jpg' },
