...
export const useMusicStore = defineStore('music', {
  state: () => ({
    ...
    currentTime: '0:00',
    playlist: [
      { src: new URL('../assets/music', import.meta.url).href, title: '1n - デート2', cover: new URL('../assets/album-img/1n - デート2.jpg', import.meta.url).href },
  ...
  actions: {
    ...
    togglePlay() {
      ...
      if (this.isPlaying) {
        ...
        albumCover.classList.add('paused'); // 添加 paused 类以暂停动画
      } else {
        this.audioPlayer.play();
        albumCover.classList.remove('paused'); // 移除 paused 类以继续动画
      }
