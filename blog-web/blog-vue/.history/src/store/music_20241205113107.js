...
export const useMusicStore = defineStore('music', {
  state: () => ({
    ...
    playlist: [
      ...
      { src: new URL('../assets/music/2n - 夏目友人帐(2nCover).mp3', import.meta.url).href, title: '../assets/music/ACK - 渐行渐远的风不再歌唱(Bright Mix)(Inst).mp3', title: 'ACK', cover: '../assets/album-img/ACK.jpg' },
