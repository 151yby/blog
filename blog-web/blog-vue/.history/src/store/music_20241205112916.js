...
export const useMusicStore = defineStore('music', {
  state: () => ({
    ...
    currentTime: '0:00',
    playlist: [
      { src: require('../assets/music/1n - デート2(1nCover).mp3'), title: '1n - デート2', cover: require('../assets/album-img/1n - デート2.jpg') },"z../assets/music/1n - デート2(1nCover).mp3", title: '1n - デート2', cover: '../assets/album-img/1n - デート2.jpg' },
      { src: '../assets/music/ACK - 渐行渐远的风不再歌唱(Bright Mix)(Inst).mp3', title: 'ACK', cover: '../assets/album-img/ACK.jpg' },
